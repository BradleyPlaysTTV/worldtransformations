...
public class Config {
    ...
    public static final ModConfigSpec.IntValue TOTAL_OUTPUT_ROWS;
    ...
    static {
        ...
        TOTAL_OUTPUT_ROWS = BUILDER
                .comment(" How many rows to have for recipe outputs. There are 9 slots in a row. Setting the value to 2 would be 18 slots")
                .defineInRange("totalOutputRows", 2, 1, 3);
        BUILDER.pop();
