package net.anderzz.worldtransform.compat;
...
import net.anderzz.worldtransform.recipe.WeightedOutput;
import net.anderzz.worldtransform.recipe.WorldTransformRecipe;
