...
import net.anderzz.worldtransform.WorldTransform;
...
public class ModRecipes {
    public static final DeferredRegister<RecipeSerializer<?>> SERIALIZERS =
            DeferredRegister.create(Registries.RECIPE_SERIALIZER, WorldTransform.MOD_ID);
    public static final DeferredRegister<RecipeType<?>> TYPES =
            DeferredRegister.create(Registries.RECIPE_TYPE, WorldTransform.MOD_ID);

    public static final Supplier<RecipeSerializer<WorldTransformRecipe>> WORLD_TRANSFORM_SERIALIZER =
            SERIALIZERS.register("world_transform", WorldTransformRecipe.Serializer::new);
